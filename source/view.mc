...
class view extends Ui.View {
    ...
    function onLayout(dc) {
       ...
       //System.println("null");
       apiToken = myapp.getProperty("apiToken");
       System.println(apiToken);
       if (apiToken != null) {
         _getData.getAccountState(apiToken);
    ...
    function renderDisplay(dc) {
        ...
        if (_properties.balance.toNumber() < _confLoad.criticalBalance ) 
        {
        ...
        dc.drawText(dc.getWidth()/2, dc.getHeight()/2, Graphics.FONT_LARGE, _properties.balance, Graphics.TEXT_JUSTIFY_CENTER | Graphics.TEXT_JUSTIFY_VCENTER);
    }
    // Update the view
    function onUpdate(dc) {
        // Call the parent onUpdate function to redraw the layout
        System.println("onUpdate() called"+apiToken+" Balance"+_properties.balance);
